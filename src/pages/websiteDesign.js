...
import HeaderWebSiteDesign from "../components/webSiteDesign/headerWebSiteDesign";
...
const WebsiteDesign = ({children}) => {
    ...
    return (
        <>
            <div className="header" ref={ refMenu }><HeaderWebSiteDesign turnOnMenu={ closeOpenMenu } />
            <DropdownServices isToggle = { isToggle } turnOffMenu={ closeMenu } /></div>
            <HeroWebSiteDesign></HeroWebSiteDesign>

...
const faqList = [
  ...
  },
  {
    ...
    a: ["Custom software development may pose several risks and challenges:", "— <strong>Scope Creep:</strong> Expanding project scope beyond initial plans, affecting timelines and costs.",
    "— <strong>Budget Overruns:</strong> Unforeseen complexities leading to increased expenses.",
    "— <strong>Timeline Delays:</strong> Technical issues, scope changes, or external factors causing delays.",
    "— <strong>Quality Assurance:</strong> Ensuring bug-free software through rigorous testing can be challenging.",
    "— <strong>Communication Issues:</strong> Misunderstandings can lead to misaligned expectations.",
    "— <strong>Technology Changes:</strong> Rapid tech advancements may necessitate updates for long-term relevance.",
  ...
  },
  {
    ...
    a: ["Custom software development may pose several risks and challenges", "— <strong>Complexity:</strong> Intricate features and functionality can increase development time and cost.",
    "— <strong>Scope:</strong> The number of features, user roles, and modules affects workload and expenses.",
    "— <strong>Technology:</strong> The choice of programming languages, frameworks, and tools can impact costs.",
    "— <strong>Design:</strong> Elaborate UI/UX design or custom graphics may incur additional expenses.",
    "— <strong>Integration:</strong> Connecting with other systems or APIs can affect complexity and budget.",
    "— <strong>Security:</strong> Implementing robust security measures adds development effort.",
    "— <strong>Testing:</strong> Rigorous testing and quality assurance contribute to the overall cost.",
    "— <strong>Customization:</strong> Tailoring the software to specific business needs may require extra effort.",
    "— <strong>Timeline:</strong> Expedited delivery might require more resources and thus higher costs.",
    "— <strong>Support and Maintenance:</strong> Including post-launch support and updates influences cost.",
     "— <strong>Team Expertise:</strong> Skilled developers may command higher rates, impacting expenses.",
    "— <strong>Geographical Location:</strong> Development costs can vary based on regional rates.", "By understanding these factors, you can make informed decisions and effectively manage your software development budget."],
  },
  {
